...
<p align="center"><strong>Medical-imaging specialist tools for DeepSeek Harness — MAIRA-2, MedGemma, TotalSegmentator, BiomedParse, and BiomedCLIP, wired in as ordinary tool calls.</strong></p>
...
<p align="center">
  <img src="assets/workflow.svg" width="100%" alt="MedPlugin workflow: a user request is routed by the DeepSeek Harness agent to a modality-specific tool (X-ray, CT, MRI, ultrasound, retinal), backed by MAIRA-2 / MedGemma / TotalSegmentator / BiomedParse / BiomedCLIP running in one shared Python venv, returning a structured result plus a preview image." />
</p>
